<template>
	<div>
		<div class="admin-panel" v-if="!adminSuc">
			<div class="text-center">Please<a href="javascript:void(0)" @click="handleClick">Login</a>Here！</div>
			...
			<div class="admin-panel-manage" :class="{'slideLeft':!!animatePanel}">
				...
				<mu-flexbox class="set-btn" wrap="wrap">
		    		<mu-flexbox-item class="flex-demo">
						<mu-flat-button label="Username" class="my-flat-button" labelClass="my-flat-label" @click="manageUser"/>
		    		</mu-flexbox-item>
		    		<mu-flexbox-item class="flex-demo">
						<mu-flat-button label="Password" class="my-flat-button" labelClass="my-flat-label" @click="logOut"/>
		    		</mu-flexbox-item>
				</mu-flexbox>
			</div>
